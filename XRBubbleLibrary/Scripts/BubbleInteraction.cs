...
namespace XRBubbleLibrary
{
    ...
    /// </summary>
    [RequireComponent(typeof(BubblePhysics))]
    public class BubbleInteraction : XRBaseInteractable
    {
        ...
        protected override void OnSelectEntered(SelectEnterEventArgs args)
        {
            ...
            // Physics feedback - compress bubble
            if (bubblePhysics != null)
            {
                bubblePhysics.OnBubblePressed();
            }
        ...
        protected override void OnSelectExited(SelectExitEventArgs args)
        {
            ...
            // Physics feedback - release bubble
            if (bubblePhysics != null)
            {
                bubblePhysics.OnBubbleReleased();
            }
